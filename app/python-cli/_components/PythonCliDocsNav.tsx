...
export default function PythonCliDocsNav({ docs, activeSlug }: PythonCliDocsNavProps) {
  ...
  return (
    <div className="hidden lg:block sticky top-16">
      <div className="surface rounded-2xl sm:rounded-3xl p-4 sm:p-5">
        ...
        <div className="tag-python-cli inline-flex items-center rounded-full px-2.5 py-0.5 sm:py-1 text-[10px] sm:text-xs uppercase tracking-[0.2em] mt-2 sm:mt-3">
          Python Agent
        </div>
                    ...
                    return (
                      <Link
                        ...
                        className={`rounded-lg px-2.5 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm transition-colors ${
                          isActive
                            ? "bg-[rgba(167,139,250,0.15)] text-[#a78bfa] font-medium"
