...
import PythonCliDocsNav from "./PythonCliDocsNav";
import { Header } from "../../_components/Header";

type PythonCliDocsShellProps = {
  docs: DocEntry[];
  doc: DocContent;
};

export default function PythonCliDocsShell({ docs, doc }: PythonCliDocsShellProps) {
        ...
        <div className="mx-auto max-w-7xl px-3 sm:px-4">
          <div className="grid grid-cols-1 gap-6 sm:gap-8 lg:gap-10 lg:grid-cols-[260px_1fr] xl:grid-cols-[260px_1fr_220px]">
            ...
            <aside className="hidden lg:block lg:pt-2">
              <PythonCliDocsNav docs={docs} activeSlug={doc.slug} />
            </aside>
            ...
            <main className="min-w-0">
              <div className="surface-strong rounded-2xl sm:rounded-[28px] px-4 sm:px-6 lg:px-10 py-6 sm:py-8 lg:py-10">
                <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                  <span className="tag-python-cli rounded-full px-2.5 py-0.5 sm:px-3 sm:py-1 text-[10px] sm:text-xs uppercase tracking-[0.15em] sm:tracking-[0.22em]">
                    {doc.section}
                  </span>
              ...
              <div className="sticky top-20 space-y-4">
                ...
                <div className="surface rounded-2xl p-4">
                  ...
                  <div className="mt-3 text-sm text-[color:var(--muted)]">
                    induscode installs as `pip install induscode` and runs as `pindus`. It builds on the
                    indusagi framework — see the Python framework docs for the layers underneath.
                  </div>
                </div>
              </div>
            </aside>
